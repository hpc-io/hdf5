...
static herr_t H5O__ainfo_pre_copy_file(const void *mesg_src, hbool_t *deleted, const H5O_copy_t *cpy_info, void *udata);
 ...
 */
static herr_t
H5O__ainfo_pre_copy_file(const void H5_ATTR_UNUSED *native_src, hbool_t *deleted, const H5O_copy_t *cpy_info, void H5_ATTR_UNUSED *udata)
{
    FUNC_ENTER_STATIC_NOERR
