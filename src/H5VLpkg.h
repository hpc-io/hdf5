...
H5_DLL herr_t  H5VL__cmp_connector_info_cls(const H5VL_class_t *vol_class, int *cmp_value, const void *info1,
                                            const void *info2);
...
H5_DLL void *         H5VL__wrap_object(const H5VL_connector_t *connector, void *wrap_ctx, void *obj,
                                        H5I_type_t obj_type);
...
H5_DLL H5VL_container_t *H5VL__get_container_for_obj(void *obj, H5I_type_t obj_type,
                                                     H5VL_container_t *orig_container);
